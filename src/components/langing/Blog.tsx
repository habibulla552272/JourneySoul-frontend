...
// Fallback image
const FALLBACK_IMAGE = 'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2072&q=80';
        ...
        <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 items-stretch'>
          {blogdata && blogdata.length > 0 ? (
            blogdata.map((item: BlogData) => {
              ...
              const imageUrl = item.image && isValidUrl(item.image) 
                ? item.image 
                : FALLBACK_IMAGE;
